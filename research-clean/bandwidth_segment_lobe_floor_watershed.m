...
cfg.datasets = struct(...
    ...
    'Dataset 3: icListen (Departmental Cruise)'}, ...
    'folder', {dir_hear_my_ship, dir_croatia, dir_cruise}, ...
    'path',   {
    % fullfile(dir_hear_my_ship, 'Motorboat_08.08.23_105220_20secCPA.wav'), ...
    fullfile(dir_garda, 'channelA_2025-08-07_20-44-20_02.wav'), ...
