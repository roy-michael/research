...
| :--- | :--- | :--- | :--- | :--- |
| **BlueWhite_Ferry_Postira** | 16 | **25.00 Hz** (-45.9 dB) | *(Same as Max)* | [View Plot](images/ferry_avg_bluewhite_ferry_postira.png) |
| **Jadrolinija** | 16 | **69.00 Hz** (-46.0 dB) | *(Same as Max)* | [View Plot](images/ferry_avg_jadrolinija.png) |
| **Jadrolinija_Lara** | 9 | **25.00 Hz** (-62.2 dB) | *(Same as Max)* | [View Plot](images/ferry_avg_jadrolinija_lara.png) |
| **Miatours_Blue_Yellow_Ferry** | 10 | **550.00 Hz** (-59.5 dB) | **163.00 Hz** (-62.8 dB) | [View Plot](images/ferry_avg_miatours_blue_yellow_ferry.png) |
...
![BlueWhite_Ferry_Postira Plot](images/ferry_avg_bluewhite_ferry_postira.png)

### Sub-Dataset: Jadrolinija (16 recordings)
* **Absolute Maximum Spectral Peak:** 69.00 Hz  

![Jadrolinija Plot](images/ferry_avg_jadrolinija.png)

### Sub-Dataset: Jadrolinija_Lara (9 recordings)
* **Absolute Maximum Spectral Peak:** 25.00 Hz  

![Jadrolinija_Lara Plot](images/ferry_avg_jadrolinija_lara.png)
...
![Miatours_Blue_Yellow_Ferry Plot](images/ferry_avg_miatours_blue_yellow_ferry.png)
