...
<head>
    ...
    <title>Garda Datasets Interactive Spectral Dashboard</title>
    ...
    <style>
        ...
        .badge-petrol-deep { background: rgba(255, 87, 34, 0.2); color: #ff5722; }
        .badge-petrol-shallow { background: rgba(237, 108, 2, 0.2); color: #ed6c02; }
...
<body>
    <header>
        <h1>Garda Acoustic Signature Dashboard</h1>
        <p class="subtitle">Interactive Welch PSD & DEMON analysis of Garda datasets (0-4 kHz)</p>
    </header>

    <div class="dashboard-container">
        <div class="card">
            <div class="card-title">
                <span>Garda Welch Power Spectral Density (PSD)</span>
                <div class="controls">
        ...
        <div class="card">
            <div class="card-title">
                <span>Garda DEMON Envelope Modulation Spectrum</span>
                <div class="controls">
    ...
    <script>
        ...
        const colors = {
            Petrol_Deep_Water: '#ff5722',
            Petrol_Shallow_Water: '#ed6c02',
            Electric_Deep_Water: '#00a2e8',
            Electric_Shallow_Water: '#38bdf8'
        };

        const labels = {
            Petrol_Deep_Water: 'Petrol (Deep Water)',
            Petrol_Shallow_Water: 'Petrol (Shallow Water)',
            Electric_Deep_Water: 'Electric (Deep Water)',
            Electric_Shallow_Water: 'Electric (Shallow Water)'
        };

        const badgeClasses = {
            Petrol_Deep_Water: 'badge-petrol-deep',
            Petrol_Shallow_Water: 'badge-petrol-shallow',
            Electric_Deep_Water: 'badge-electric-deep',
            Electric_Shallow_Water: 'badge-electric-shallow'
        };
