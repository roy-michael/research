...
function plot_spectrogram(samplerate, data)
    ...
    fig = figure('Name', 'Spectrogram of 2407_1 (10-min segment)', ...
    ...
    xlabel(ax, 'Time [sec]');
    title(ax, 'Spectrogram of 2407_1 (Minutes 20-30)');
    
    cb = colorbar(ax);
    cb.Label.String = 'Power/Frequency (dB/Hz)';
    
    % Save plot
    out_file = 'spectrogram_2407_1_10min.png';
