...
% leaves only the Welch PSD, Zoomed Welch PSD (0-4 kHz), Reflection Envelope PSD (showing intersections), and STD subplots,
% and opens the figure interactively ('Visible', 'on') for live exploration in MATLAB.
...
% -------------------------------------------------------------
% 3. Plotting Live/Interactive Plots
% -------------------------------------------------------------

fig = figure('Name', 'Narrowband PSD & Decidecade Band Analysis (Interactive)', 'Position', [100, 100, 1400, 1500]);
...
% Enable zoom/pan mode automatically on the figure
zoom(fig, 'on');

fprintf('Interactive plot is live! You can now use the MATLAB figure zoom/pan tools.\n');
