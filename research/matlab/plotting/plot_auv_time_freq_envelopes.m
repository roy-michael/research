% plot_auv_time_freq_envelopes.m
% Loads the AUV Leg 1 dataset and creates a unified multi-panel figure
...
try
    ...
    % =============================================================
    fig = figure('Name', 'AUV Leg 1 - Time & Frequency Envelopes and Peak Tracking', 'Position', [150, 30, 1400, 1050]);
    ...
    fprintf('Unified AUV Time & Frequency Envelope plot with Peak Tracking is live!\n');
