% plot_croatia_time_freq_envelopes.m
% Loads the Croatia snake dataset and creates a unified multi-panel figure
...
try
    ...
    % =============================================================
    fig = figure('Name', 'Croatia Snake - Time & Frequency Envelopes and Peak Tracking', 'Position', [200, 30, 1400, 1050]);
    ...
    plot(ax1, t_ds, env_up_ds, 'Color', [0.4940 0.1840 0.5560], 'LineWidth', 1.2, 'DisplayName', 'Upper Envelope');
    ...
    hold(ax3, 'on');
    plot(ax3, f_nb, psd_nb_db, 'Color', [0.4940 0.1840 0.5560], 'LineWidth', 1.0, 'DisplayName', 'Welch PSD');
    ...
    hold(ax4, 'on');
    plot(ax4, f_nb(zoom_range), psd_nb_db(zoom_range), 'Color', [0.4940 0.1840 0.5560], 'LineWidth', 1.5, 'DisplayName', 'Welch PSD');
    ...
    fprintf('Unified Croatia Time & Frequency Envelope plot with Peak Tracking is live!\n');
