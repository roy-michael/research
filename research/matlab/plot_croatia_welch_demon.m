% plot_croatia_welch_demon.m
% Computes and compares Welch PSD and DEMON spectra for the Croatia datasets
% (2307_free, 2407_1_600m, 2407_2_snake, 2507_1_1k, 2507_2_joint),
...
DATASETS = {
    ...
    'D:\RoyStudies\Recordings\Croatia\Ocean Sonics\2407_1_600m', 'Croatia_2407_1_600m';
    'D:\RoyStudies\Recordings\Croatia\Ocean Sonics\2407_2_snake', 'Croatia_2407_2_snake';
    'D:\RoyStudies\Recordings\Croatia\Ocean Sonics\2507_1_1k', 'Croatia_2507_1_1k';
    'D:\RoyStudies\Recordings\Croatia\Ocean Sonics\2507_2_joint', 'Croatia_2507_2_joint'
};
...
fid = fopen(fullfile(output_dir, 'croatia_spectral_data.json'), 'w');
fprintf(fid, '%s', json_str);
fclose(fid);
fprintf('Saved croatia_spectral_data.json to output directory\n');
...
% --- Figure 1: Welch PSD ---
fig_welch = figure('Name', 'Croatia Welch PSD (Signals Highlighted)', 'Position', [100, 100, 1200, 700], 'Visible', 'off');
...
title(ax_welch, 'Croatia Welch PSD: Highlighted Signals & Bandwidths (0-4 kHz)');
grid(ax_welch, 'on');
xlim(ax_welch, [0, 4]);
legend(ax_welch, 'Location', 'northeast');
hold(ax_welch, 'off');
saveas(fig_welch, fullfile(output_dir, 'croatia_welch_plot.png'));

% --- Figure 2: DEMON ---
fig_demon = figure('Name', 'Croatia DEMON (Signals Highlighted)', 'Position', [100, 100, 1200, 700], 'Visible', 'off');
...
title(ax_demon, 'Croatia DEMON Spectrum: Highlighted Signals & Bandwidths (0-4 kHz)');
grid(ax_demon, 'on');
xlim(ax_demon, [0, 4000]);
legend(ax_demon, 'Location', 'northeast');
hold(ax_demon, 'off');
saveas(fig_demon, fullfile(output_dir, 'croatia_demon_plot.png'));

fprintf('Croatia analysis and exports finished successfully!\n');
close(fig_welch);
close(fig_demon);
